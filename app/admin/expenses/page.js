...
export default function AdminExpensesPage() {
  ...
  // Inline category/subcategory creation states
  const [showInlineCategoryInput, setShowInlineCategoryInput] = useState(false);
  const [showInlineSubcategoryInput, setShowInlineSubcategoryInput] = useState(false);
  ...
  const [creatingInlineSubcategory, setCreatingInlineSubcategory] = useState(false);
  ...
  const handleCreateInlineCategory = async () => {
    ...
    const createToast = toast.loading("Creating category...");
    ...
    try {
      ...
      toast.success("Category created successfully!", { id: createToast });

      // Update categories list and select the new category
      await fetchCategories();
      setExpenseForm({ ...expenseForm, categoryId: category.id, subcategoryId: "" });
      ...
      toast.error("Failed to create category: " + error.message, { id: createToast });
    } finally {
  ...
  const handleCreateInlineSubcategory = async () => {
    ...
    setCreatingInlineSubcategory(true);
    const createToast = toast.loading("Creating subcategory...");
    ...
    try {
      ...
      toast.success("Subcategory created successfully!", { id: createToast });

      // Update subcategories list and select the new subcategory
      await fetchSubcategories();
      setExpenseForm({ ...expenseForm, subcategoryId: subcategory.id });

      // Reset inline form
      setInlineSubcategoryName("");
      setShowInlineSubcategoryInput(false);
    } catch (error) {
      console.error("Error creating subcategory:", error);
      toast.error("Failed to create subcategory: " + error.message, { id: createToast });
    } finally {
      setCreatingInlineSubcategory(false);
    }
  };
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-14 pr-4 py-3 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-lg font-semibold"
                placeholder="0.00"
              />
            </div>
          </div>
            ...
            {!showInlineCategoryInput ? (
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full py-2 px-4 border-2 border-dashed border-indigo-300 dark:border-indigo-700 text-indigo-600 dark:text-indigo-400 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors text-sm font-medium flex items-center justify-center"
                >
              ...
              <div className="space-y-2 p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-indigo-300 dark:border-indigo-700 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm"
                    autoFocus
                  />
                </div>
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    disabled={creatingInlineCategory || !inlineCategoryName.trim()}
                    className="flex-1 py-2 px-3 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 disabled:cursor-not-allowed text-white rounded-lg text-sm font-medium transition-colors flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    className="py-2 px-3 bg-gray-200 hover:bg-gray-300 dark:bg-slate-600 dark:hover:bg-slate-500 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium transition-colors"
                  >
                    Cancel
                  </button>
                </div>
            ...
            <div>
              ...
              {!showInlineSubcategoryInput ? (
                <div className="space-y-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setShowInlineSubcategoryInput(true)}
                    className="w-full py-2 px-4 border-2 border-dashed border-purple-300 dark:border-purple-700 text-purple-600 dark:text-purple-400 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors text-sm font-medium flex items-center justify-center"
                  >
                    <Plus className="w-4 h-4 mr-1" />
                    Add New Subcategory
                  </button>
                ...
                <div className="space-y-2 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-purple-300 dark:border-purple-700 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm"
                      autoFocus
                    />
                  </div>
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      disabled={creatingInlineSubcategory || !inlineSubcategoryName.trim()}
                      className="flex-1 py-2 px-3 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 disabled:cursor-not-allowed text-white rounded-lg text-sm font-medium transition-colors flex items-center justify-center"
                    >
                      {creatingInlineSubcategory ? (
                        <>Creating...</>
                      ) : (
                        <>
                          <Save className="w-3 h-3 mr-1" />
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      <div
                        className={`w-8 h-8 bg-gradient-to-r ${method.color} rounded-lg flex items-center justify-center mb-1`}
                      >
